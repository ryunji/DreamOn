...
public class CrawlingController {
    ...
    public ResponseEntity<Integer> crawling(HttpServletRequest request){
        ...
        for (NewsSource source : newsSourceList) {
            ...
            String targetUrl = source.getUrl();                                                                                           //"https://www.newsnjob.com/news/articleList.html?sc_section_code=S1N2&view_type=sm";//                                             //"https://www.newsnjob.com/news/articleList.html?sc_section_code=S1N2&view_type=sm";
    ...
    System.out.println(index + "제목 : " + title);
                    ...
                    WebElement linkElm  = element.findElement(By.className("list-titles").tagName("a"));
                    String link         = linkElm.getAttribute("href");
                    
System.out.println("link : " + link);

                     int fstIndex = link.indexOf("=");
                     String idxNo = link.substring(fstIndex+1);
System.out.println("idxNo = " + idxNo);
    ...
    //System.out.println("imgURL : " + imgURL);
                    imgURL    = imgURL.replaceFirst(".", domain);
                    String imgPath = "";
    ...
    //System.out.println("The address of the picture downloaded: " + imgURL);
                ...
                newsService.saveNewsData(list); //신규 뉴스 저장.
     ...
     private static String downToFolder(String downPath, String downImgUrl, String[] fileName) {
        ...
        try{
          ...
          //imgPath = downPath + "/" + FILE_NUM + "_"+ fileName[1];
            ...
            downPath = downPath.replace("D:\\class-7\\MayoImg", "");
            savePath = "\\" + "imagePath" + downPath + "\\" + fileName[1];
